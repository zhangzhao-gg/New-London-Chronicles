...
export const PLAYLISTS: AudioPlaylist[] = [
  {
    ...
    icon: "flame",
    tracks: [
      { id: "white-furnace", title: "White Furnace Echo", fileLabel: "white_furnace_echo", src: "/audio/music/white-furnace-echo.mp3" },
      { id: "ash-in-snow", title: "Ash in the Snow", fileLabel: "ash_in_the_snow", src: "/audio/music/ash-in-the-snow.mp3" },
      { id: "ash-in-snow-ii", title: "Ash in the Snow II", fileLabel: "ash_in_the_snow_ii", src: "/audio/music/ash-in-the-snow-ii.mp3" },
      { id: "ash-on-wind", title: "Ash on the Wind", fileLabel: "ash_on_the_wind", src: "/audio/music/ash-on-the-wind.mp3" },
      { id: "ash-on-wind-ii", title: "Ash on the Wind II", fileLabel: "ash_on_the_wind_ii", src: "/audio/music/ash-on-the-wind-ii.mp3" },
      { id: "blizzard-room", title: "Blizzard Room at Last Call", fileLabel: "blizzard_room", src: "/audio/music/blizzard-room-at-last-call.mp3" },
      { id: "clockwork-snowfall", title: "Clockwork Snowfall", fileLabel: "clockwork_snowfall", src: "/audio/music/clockwork-snowfall.mp3" },
      { id: "coal-cabin", title: "Coal Cabin Lullaby", fileLabel: "coal_cabin_lullaby", src: "/audio/music/coal-cabin-lullaby.mp3" },
      { id: "cold-outside", title: "Cold Outside, Codes Inside", fileLabel: "cold_outside_codes_inside", src: "/audio/music/cold-outside-codes-inside.mp3" },
      { id: "cold-outside-ii", title: "Cold Outside, Codes Inside II", fileLabel: "cold_outside_codes_inside_ii", src: "/audio/music/cold-outside-codes-inside-ii.mp3" },
      { id: "embers-rain", title: "Embers in the Rain", fileLabel: "embers_in_the_rain", src: "/audio/music/embers-in-the-rain.mp3" },
      { id: "rain-windowpane", title: "Rain on the Windowpane", fileLabel: "rain_on_the_windowpane", src: "/audio/music/rain-on-the-windowpane.mp3" },
      { id: "old-furnace", title: "Old Furnace Recording", fileLabel: "old_furnace_recording", src: "/audio/music/old-furnace-recording.mp3" },
      { id: "old-furnace-ii", title: "Old Furnace Recording II", fileLabel: "old_furnace_recording_ii", src: "/audio/music/old-furnace-recording-ii.mp3" },
    ],
  },
  {
    id: "frostpunk-ost",
    ...
    icon: "snowflake",
    tracks: [
      { id: "frostpunk-theme", title: "Frostpunk Theme", fileLabel: "frostpunk_theme", src: "/audio/music/frostpunk-theme.mp3" },
      { id: "are-we-alone", title: "Are We Alone", fileLabel: "are_we_alone", src: "/audio/music/are-we-alone.mp3" },
      { id: "darkest-days", title: "The Darkest of Days", fileLabel: "the_darkest_of_days", src: "/audio/music/the-darkest-of-days.mp3" },
      { id: "streets-new-london", title: "Streets of New London", fileLabel: "streets_of_new_london", src: "/audio/music/streets-of-new-london.mp3" },
      { id: "brave-new-world", title: "Brave New World", fileLabel: "brave_new_world", src: "/audio/music/brave-new-world.mp3" },
      { id: "last-flame", title: "The Last Flame", fileLabel: "the_last_flame", src: "/audio/music/the-last-flame.mp3" },
      { id: "the-shepherd", title: "The Shepherd", fileLabel: "the_shepherd", src: "/audio/music/the-shepherd.mp3" },
      { id: "into-storm", title: "Into the Storm", fileLabel: "into_the_storm", src: "/audio/music/into-the-storm.mp3" },
      { id: "city-must-survive", title: "The City Must Survive", fileLabel: "the_city_must_survive", src: "/audio/music/the-city-must-survive.mp3" },
      { id: "damned-souls", title: "Damned Souls", fileLabel: "damned_souls", src: "/audio/music/damned-souls.mp3" },
      { id: "still-cold-world", title: "The Still, Cold World", fileLabel: "the_still_cold_world", src: "/audio/music/the-still-cold-world.mp3" },
      { id: "last-autumn", title: "The Last Autumn Theme", fileLabel: "the_last_autumn_theme", src: "/audio/music/the-last-autumn-theme.mp3" },
    ],
  },
  {
    id: "expedition-night",
    ...
    icon: "globe",
    tracks: [
      { id: "ashen-watch", title: "Ashen Watch Lullaby", fileLabel: "ashen_watch_lullaby", src: "/audio/music/ashen-watch-lullaby.mp3" },
    ],
  },
];
